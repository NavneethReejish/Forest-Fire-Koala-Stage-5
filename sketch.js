...
function draw() {
   ...
   let display = touches.length + ' touches';
    ...
    if (gameState === INFO) {
        ...
        if (gameState === INFO && pg1Button.visible === true && mousePressedOver(pg1Button) || gameState === INFO && pg1Button.visible === true && touches.length > 0) {
            gameState = INFO;
            touches = [];
        }

        if (gameState === INFO && pg2Button.visible === true && mousePressedOver(pg2Button) || gameState === INFO && pg2Button.visible === true && touches.length > 0) {
            gameState = INFO2;
            touches = [];
        }

        if (gameState === INFO && pg3Button.visible === true && mousePressedOver(pg3Button) || gameState === INFO && pg3Button.visible === true && touches.length > 0) {
            gameState = INFO3;
            touches = [];
        }
        ...
        if (gameState === INFO2 && pg1Button.visible === true && mousePressedOver(pg1Button) || gameState === INFO2 && pg1Button.visible === true && touches.length > 0) {
            gameState = INFO;
            touches = [];
        }

        if (gameState === INFO2 && pg2Button.visible === true && mousePressedOver(pg2Button) || gameState === INFO2 && pg2Button.visible === true && touches.length > 0 ) {
            gameState = INFO2;
            touches = [];
        }

        if (gameState === INFO2 && pg3Button.visible === true && mousePressedOver(pg3Button) || gameState === INFO2 && pg3Button.visible === true && touches.length > 0 ) {
            gameState = INFO3;
            touches = [];
        }
        ...
        text("Avoid the fires by using the space bar or by pressing the jump button.", 15, 150);
        ...
        if (gameState === INFO3 && PlayButton.visible === true && mousePressedOver(PlayButton) || gameState === INFO3 && PlayButton.visible === true && touches.length > 0) {
            gameState = PLAY
            touches = [];
        }

        if (gameState === INFO3 && pg1Button.visible === true && mousePressedOver(pg1Button) || gameState === INFO3 && pg1Button.visible === true && touches.length > 0) {
            gameState = INFO;
            touches = [];
        }

        if (gameState === INFO3 && pg2Button.visible === true && mousePressedOver(pg2Button) || gameState === INFO3 && pg2Button.visible === true && touches.length > 0) {
            gameState = INFO2;
            touches = [];
        }

        if (gameState === INFO3 && pg3Button.visible === true && mousePressedOver(pg3Button) || gameState === INFO3 && pg3Button.visible === true && touches.length > 0) {
            gameState = INFO3;
            touches = [];
        }
